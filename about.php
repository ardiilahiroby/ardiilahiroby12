...
<body class="bg-gray-100 dark:bg-gray-900 text-gray-800 dark:text-gray-200 font-sans">
    ...
    <nav class="bg-gray-200 dark:bg-gray-800 shadow">
        <div class="max-w-7xl mx-auto px-4 py-3 flex justify-between items-center">
            <div class="text-lg font-semibold">Ardi Ilahi Roby</div>
            <div class="flex items-center space-x-4">
                 <a href="about.php" class="font-bold underline text-blue-600 dark:text-blue-400">Tentang</a>
                <a href="index.php" class="hover:underline font-medium">Artikel</a>
                <a href="gallery.php" class="hover:underline font-medium">Galeri</a>
                <a href="contact.php" class="hover:underline font-medium">Kontak</a>
                <a href="admin/login.php" class="hover:underline font-medium">Login</a>
                <button onclick="toggleDarkMode()"
                    class="px-3 py-1 bg-gray-300 dark:bg-gray-600 rounded text-sm">🌙</button>
            </div>
        </div>
    </nav>

    <!-- Konten -->
    <main class="flex flex-col items-start justify-start min-h-screen px-6 py-12 max-w-6xl mx-auto">

        <!-- Judul -->
        <h2 class="text-2xl font-bold mb-8 text-blue-700 dark:text-blue-400">Tentang Saya</h2>

        <!-- Profil: Foto & Teks sejajar -->
        <div class="w-full flex flex-row items-center flex-wrap gap-6 mb-12">

            <!-- Foto -->
            <div
                class="w-32 h-32 sm:w-40 sm:h-40 md:w-56 md:h-56 rounded-full overflow-hidden shadow-lg border-4 border-blue-600">
                <img src="admin/assets/img/ardi.jpg" alt="Foto Ardi Ilahi Roby" class="object-cover w-full h-full" />
            </div>


            <!-- Teks Profil -->
            <div>
                <p class="text-blue-700 text-lg sm:text-xl font-semi bold mb-2">Halo Semua 👋, saya</p>
                <h1 class="text-3xl sm:text-5xl font-bold text-blue-900 dark:text-white mb-2">Ardi Ilahi Roby</h1>
                <p class="text-lg sm:text-xl text-white-600 dark:text-white-400">
                    Web Development | Mahasiswa Sistem Informasi
                </p>
            </div>
        </div>
        ...
        <section class="w-full">
            <div class="flex justify-center">
                ...
                while ($data = mysqli_fetch_array($query)) {
                    echo "<div>";
                    echo "<p class='text-white-700'>" . htmlspecialchars($data['about'])
                        . "</p>";
                    echo "</div>";
                }
                ?>
