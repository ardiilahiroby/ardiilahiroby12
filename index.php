...
<!DOCTYPE html>
<html lang="en" class="<?= (isset($_COOKIE['theme']) && $_COOKIE['theme'] == 'light') ? '' : 'dark'; ?>">
...
<body class="bg-white dark:bg-gray-900 text-black dark:text-white transition-colors duration-300">
    ...
    <nav class="bg-gray-200 dark:bg-gray-800 shadow">
        <div class="max-w-7xl mx-auto px-4 py-3 flex justify-between items-center">
            ...
            <div class="flex items-center space-x-4">
                <a href="about.php" class="hover:underline font-medium">Tentang</a>
                <a href="index.php" class="font-bold underline text-blue-600 dark:text-blue-400">Artikel</a>
                ...
                <!-- Dark Mode Toggle -->
                <button onclick="toggleDarkMode()" class="px-3 py-1 bg-gray-300 dark:bg-gray-600 rounded text-sm">
                    🌙
                </button>
            </div>
        </div>
    ...
    <!-- Main Content -->
    <main class="max-w-2xl mx-auto mt-10 mb-16 px-4">
        <div class="bg-gray-100 dark:bg-gray-800 p-6 rounded-lg shadow-md">
            <h2 class="text-3xl font-bold mb-6 text-center">Artikel Terbaru</h2>
            <div class="space-y-6">
                <?php
                ...
                while ($data = mysqli_fetch_array($query)) {
                    ...
                    <article class="border-b pb-4">
                        <h3 class="text-2xl font-semibold text-blue-700 dark:text-blue-400 mb-2">
