...
<body class="bg-gray-100 dark:bg-gray-900 text-gray-800 dark:text-gray-200 font-sans min-h-screen fade-in">
    <!-- Navbar -->
    <nav class="bg-white dark:bg-gray-800 shadow p-4 flex justify-between items-center">
        <h1 class="text-xl font-bold text-blue-700 dark:text-blue-300">KELOLA GALLERY</h1>
    ...
    <main class="max-w-7xl mx-auto px-4 mt-6">
        <div class="flex justify-between items-center mb-6">
            <a href="add_gallery.php" class="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700 transition">
                + Tambah Gambar
            </a>
        </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
            ...
            while ($data = mysqli_fetch_array($query)) {
                echo "<div class='bg-white dark:bg-gray-700 border dark:border-gray-600 rounded-lg shadow'>";
                echo "<img src='../images/" . htmlspecialchars($data['foto']) . "' alt='" . htmlspecialchars($data['judul']) . "' class='w-full h-48 object-cover rounded-t-lg'>";
                echo "<div class='p-4'>";
