...
<body class="bg-gray-100 dark:bg-gray-900 text-gray-900 dark:text-white min-h-screen">
    ...
    <nav class="bg-white dark:bg-gray-800 shadow p-4 flex justify-between items-center">
        <h1 class="text-xl font-bold text-blue-700 dark:text-blue-300">EDIT GALLERY</h1>
        <ul class="flex space-x-6">
            <li><a href="about.php" class="hover:text-blue-600 dark:hover:text-blue-300">Tentang</a></li>
            <li><a href="beranda_admin.php" class="hover:text-blue-600 dark:hover:text-blue-300">Beranda</a></li>
            <li><a href="data_artikel.php" class="hover:text-blue-600 dark:hover:text-blue-300">Artikel</a></li>
            <li><a href="data_gallery.php" class="text-blue-800 dark:text-blue-400 font-semibold">Gallery</a></li>
            <li><a href="data_contact.php" class="hover:text-blue-600 dark:hover:text-blue-300">Kontak</a></li>
            <li><a href="logout.php" onclick="return confirm('Apakah Anda yakin ingin keluar?');"
                    class="text-red-600 hover:underline">Logout</a></li>
        </ul>
        <button onclick="document.documentElement.classList.toggle('dark')"
            class="ml-4 bg-gray-300 dark:bg-gray-600 text-sm px-3 py-1 rounded">
            🌙
        </button>
    </nav>
    ...
    <div class="max-w-4xl mx-auto mt-8 p-6 bg-white dark:bg-gray-800 rounded shadow">
        <h2 class="text-2xl font-bold mb-6 text-blue-800 dark:text-blue-300">Edit Gambar Gallery</h2>
        ...
        <form action="proses_edit_gallery.php" method="post" enctype="multipart/form-data" class="space-y-6">
            ...
            <div>
                ...
                <img src="../images/<?= $data['foto']; ?>" class="h-40 rounded shadow mb-3" alt="Gambar Lama">
            </div>

            <div>
                <label for="foto" class="block text-sm font-medium mb-1">Ganti Gambar (opsional)</label>
                <input type="file" id="foto" name="foto" accept="image/*"
                    class="block w-full text-sm file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-blue-100 file:text-blue-700 hover:file:bg-blue-200 dark:file:bg-gray-700 dark:file:text-white">
            </div>
            ...
            <div class="flex justify-end space-x-4">
                ...
                <a href="data_gallery.php"
                    class="bg-gray-300 text-gray-800 px-4 py-2 rounded hover:bg-gray-400 dark:bg-gray-600 dark:text-white dark:hover:bg-gray-500">Batal</a>
            </div>
