...
<body class="bg-gray-100 dark:bg-gray-900 text-gray-800 dark:text-gray-200 font-sans min-h-screen">
    ...
    <nav class="bg-white dark:bg-gray-800 shadow p-4 flex justify-between items-center">
        <h1 class="text-xl font-bold text-blue-700 dark:text-blue-300">KELOLA ARTIKEL</h1>
    ...
    <!-- Main Content -->
    <main class="max-w-7xl mx-auto p-4 mt-6 bg-white dark:bg-gray-800 rounded-lg shadow-lg">
            ...
            <table class="min-w-full table-auto border border-gray-300 dark:border-gray-600 text-sm">
                ...
                <tbody>
                    ...
                    while ($data = mysqli_fetch_array($query)) {
                        echo "<tr class='even:bg-gray-100 dark:even:bg-gray-700'>";
                        echo "<td class='p-2 border text-center'>" . $no++ . "</td>";
                        echo "<td class='p-2 border'>" . htmlspecialchars($data['nama_artikel']) . "</td>";
                        echo "<td class='p-2 border'>" . htmlspecialchars($data['isi_artikel']) . "</td>";
                        echo "<td class='p-2 border text-center space-x-2'>
