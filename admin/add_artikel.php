...
<body class="bg-gray-100 dark:bg-gray-900 text-gray-800 dark:text-gray-100 min-h-screen">
    ...
    <nav class="bg-white dark:bg-gray-800 shadow p-4 flex justify-between items-center">
        <h1 class="text-xl font-bold text-blue-700 dark:text-blue-300">TAMBAH ARTIKEL</h1>
    ...
    <div class="max-w-5xl mx-auto mt-10 bg-white dark:bg-gray-800 p-6 rounded shadow">
        <h2 class="text-2xl font-bold mb-6 text-blue-700 dark:text-blue-300 text-center">Tambah Artikel Baru</h2>
        ...
        <form action="proses_add_artikel.php" method="post" class="space-y-6">
            ...
            <div>
                ...
                <textarea id="isi_artikel" name="isi_artikel" rows="6" required
                    class="w-full p-2 border rounded bg-gray-50 dark:bg-gray-700 dark:border-gray-600 focus:outline-none focus:ring focus:border-blue-500"></textarea>
            </div>
