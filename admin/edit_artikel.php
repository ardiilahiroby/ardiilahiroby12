...
<body class="bg-gray-100 dark:bg-gray-900 text-gray-900 dark:text-white min-h-screen">
    ...
    <nav class="bg-white dark:bg-gray-800 shadow p-4 flex justify-between items-center">
        <h1 class="text-xl font-bold text-blue-700 dark:text-blue-300">EDIT ARTIKEL</h1>
        <ul class="flex space-x-6 text-sm font-medium">
            ...
            <li><a href="data_artikel.php" class="text-blue-700 dark:text-blue-300">Artikel</a></li>
            <li><a href="data_gallery.php" class="hover:text-blue-600 dark:hover:text-blue-400">Gallery</a></li>
    ...
    <!-- Main Content -->
    <div class="max-w-4xl mx-auto bg-white dark:bg-gray-800 shadow rounded p-6 mt-10">
        <label for="artikel" class="block mb-2 text-sm font-medium">Deskripsi Artikel</label>
        <form action="proses_edit_artikel.php" method="post" class="space-y-6">
            ...
            <div>
                ...
                <input type="text" id="nama_artikel" name="nama_artikel" required
                    ...
                    class="w-full p-2 border rounded focus:outline-none focus:ring focus:border-blue-500 dark:bg-gray-700 dark:text-white dark:border-gray-600">
            </div>
            ...
            <div>
                ...
                <textarea id="isi_artikel" name="isi_artikel" rows="6" required
                    class="w-full p-2 border rounded focus:outline-none focus:ring focus:border-blue-500 dark:bg-gray-700 dark:text-white dark:border-gray-600"><?= htmlspecialchars($data['isi_artikel']); ?></textarea>
            </div>
            ...
            <div class="flex justify-end space-x-4">
                ...
                <a href="data_artikel.php"
                    class="bg-gray-300 text-gray-700 px-4 py-2 rounded hover:bg-gray-400 dark:bg-gray-600 dark:text-white dark:hover:bg-gray-700">Batal</a>
            </div>
        </form>
    </div>
