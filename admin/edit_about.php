...
$id = isset($_GET['id_about']) ? mysqli_real_escape_string($db, $_GET['id_about']) : '';
...
<body class="bg-gray-100 dark:bg-gray-900 dark:text-white min-h-screen">
    ...
    <nav class="bg-white dark:bg-gray-800 shadow p-4 flex justify-between items-center">
        <h1 class="text-xl font-bold text-blue-700 dark:text-blue-300">EDIT TENTANG</h1>
        <ul class="flex space-x-4 items-center text-gray-800 dark:text-white">
            <li><a href="beranda_admin.php" class="hover:underline">Beranda</a></li>
            <li><a href="about.php" class="hover:underline">Tentang</a></li>
            <li><a href="data_artikel.php" class="hover:underline">Artikel</a></li>
            <li><a href="data_gallery.php" class="hover:underline">Gallery</a></li>
            <li><a href="data_contact.php" class="hover:underline">Kontak</a></li>
            <li><a href="logout.php" onclick="return confirm('Apakah Anda yakin ingin keluar?');"
                    class="text-red-500 hover:underline font-medium">Logout</a></li>
            <li>
    ...
    <!-- Main Content -->
    <main class="max-w-4xl mx-auto mt-10 p-6 bg-white dark:bg-gray-800 rounded shadow-md">

        <form action="proses_edit_about.php" method="post" class="space-y-6">
            <input type="hidden" name="id_about" value="<?= $data['id_about']; ?>">

            <div>
                <label for="about" class="block mb-2 text-sm font-medium">Deskripsi Tentang</label>
                <textarea name="about" id="about" rows="6" required
                    class="w-full p-3 border border-gray-300 rounded dark:bg-gray-700 dark:border-gray-600 dark:text-white focus:outline-none focus:ring focus:ring-blue-400"><?= htmlspecialchars($data['about']); ?></textarea>
            </div>

            <div class="flex justify-end space-x-4">
                <button type="submit"
                    class="bg-blue-700 text-white px-6 py-2 rounded hover:bg-blue-800 transition">Simpan</button>
                <a href="about.php"
                    class="bg-gray-300 dark:bg-gray-600 text-gray-800 dark:text-white px-6 py-2 rounded hover:bg-gray-400 dark:hover:bg-gray-500 transition">Batal</a>
            </div>
        </form>
    </main>
