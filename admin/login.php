...
<head>
    <meta charset="UTF-8">
    <title>Login | Ardi Ilahi Roby</title>
...
<body class="bg-white dark:bg-gray-900 text-gray-800 dark:text-white transition duration-300">
    ...
    <nav class="bg-gray-200 dark:bg-gray-800 shadow">
        <div class="max-w-7xl mx-auto px-4 py-3 flex justify-between items-center">
            ...
            <div class="flex space-x-4 items-center">
                ...
                <a href="../gallery.php" class="hover:underline">Galeri</a>
                <a href="../contact.php" class="hover:underline">Kontak</a>
                <a href="login.php" class="font-bold underline text-blue-600 dark:text-blue-400">Login</a>
                <!-- Tombol dark mode -->
    ...
    <main class="flex justify-center items-center min-h-screen px-4">
        <div class="w-full max-w-md bg-white dark:bg-gray-800 p-8 rounded-xl shadow-lg text-center">
            <h2 class="text-2xl font-bold text-blue-700 dark:text-blue-300 mb-4">Login Admin</h2>

            <div class="mb-6">
                <img src="assets/img/ardi.png" alt="Ardi"
                    class="w-32 h-32 mx-auto rounded-full shadow-md border dark:border-gray-600">
            </div>

            <?php if (isset($_GET['error'])): ?>
                <p class="text-red-500 mb-4 font-medium"><?php echo htmlspecialchars($_GET['error']); ?></p>
            <?php endif; ?>
            ...
            <form action="cek_login.php" method="POST" class="space-y-4 text-left">
                <div>
                    ...
                    <input type="text" id="username" name="username" required
                        class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded bg-white dark:bg-gray-900 text-gray-800 dark:text-white">
                </div>
                <div>
                ...
                <div class="flex justify-between">
                    ...
                    <input type="reset" value="Reset"
                        class="bg-gray-400 dark:bg-gray-600 text-white px-4 py-2 rounded hover:bg-gray-500 cursor-pointer">
                </div>
            </form>
        </div>
    </main>
