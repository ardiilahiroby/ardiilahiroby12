...
<!DOCTYPE html>
<html lang="id" class="dark"> <!-- default aktif dark -->

<head>
    <meta charset="UTF-8">
    <title>Kontak | Ardi Ilahi Roby</title>
...
<body class="bg-white dark:bg-gray-900 text-black dark:text-white transition-colors duration-300">
    ...
    <nav class="bg-gray-200 dark:bg-gray-800 shadow">
        <div class="max-w-7xl mx-auto px-4 py-3 flex justify-between items-center">
            ...
            <div class="flex space-x-4 items-center">
                ...
                <a href="contact.php" class="font-bold underline text-blue-600 dark:text-blue-400">Kontak</a>
    ...
    <main class="max-w-2xl mx-auto mt-10 mb-16 px-4">
        <div class="bg-gray-100 dark:bg-gray-800 p-6 rounded-lg shadow-md">
            <h2 class="text-3xl font-bold mb-6 text-center">Hubungi Saya</h2>
            <form action="proses_contact.php" method="POST">
                ...
                <div class="mb-4">
                    <label for="pesan" class="block mb-1 font-medium">Pesan</label>
                    <textarea id="pesan" name="pesan" rows="5" required
                        class="w-full p-2 rounded border dark:bg-gray-700 dark:border-gray-600"></textarea>
                </div>

                <button type="submit"
                    class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded transition">Kirim</button>
            </form>
        </div>
    </main>
